...
*}} param0 
*/
module.exports.saveTraderEstimatedTotalCurrentBalance = async function saveTraderEstimatedTotalCurrentBalance({
    mongoDatabase,estimated_total_balance,traderDocument
}){
    const FUNCTION_NAME = "(fn:saveTraderEstimatedTotalCurrentBalance)";
    console.log(FUNCTION_NAME);
    try{

        const updateResult = await mongoDatabase.collection.topTradersCollection.updateDocument(traderDocument._id,{
            estimated_total_current_balance: estimated_total_balance
        });
