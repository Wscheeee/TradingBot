...
module.exports.performUniversalTransfer =  async function performUniversalTransfer({
    ...
    console.log({ masterBybit,bybit,amount,fromMemberId,subAccountsUids,toMemberId});
    try{
        ...
        const createUniversalTransfer_Res = await masterBybit.clients.bybit_RestClientV5.createUniversalTransfer({
            amount,
            coin:"USDT",
        ...
        // const createUniversalTransfer_Res = await bybit.clients.bybit_AccountAssetClientV3.createSubAccountTransfer({
        // // const createUniversalTransfer_Res = await masterBybit.clients.bybit_AccountAssetClientV3.createSubAccountTransfer({
        //     transferId: require("../../Utils/generateUID").generateUID(),
        //     coin: "USDT",
        //     amount,
        //     subMemberId: fromMemberId,
        //     type:"OUT"
        // });
