...
const {MembershipUser_Interface,MembershipUsers_Collection_Document_Interface} = require("./types/index")



module.exports.MembershipUsersCollection =  class MembershipUsersCollection{
    #COLLECTION_NAME = 'Membership_Users';
    /**
     * @type {Db}
     */
    #database;
    /**
     * @type {Collection<MembershipUsers_Collection_Document_Interface>}
     */
    #collection;
    /**
     * @type {ChangeStream[]}
    ...
    /**
     * 
     * @param {MembershipUser_Interface} doc 
     * @returns {MembershipUsers_Collection_Document_Interface}
     */
