...
module.exports.TopTradersCollection =  class TopTradersCollection{
    ...
    #database;
    /**
     * @type {import("mongodb").Collection<import("./types").TopTrader_Interface>}
     */
    #collection;
    /**
    ...
    /**
     * 
     * @param {import("./types").TopTrader_Interface} doc 
     ...
     * @returns {Promise<import("mongodb").WithId<import("./types").TopTrader_Interface> | null> }
     */
