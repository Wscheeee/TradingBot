...
module.exports.Bybit_AccountAssetClientV3 = class Bybit_AccountAssetClientV3 {
    ...
    */
    ...
    static  createAccountAssetClientV3({privateKey,publicKey,testnet}){
        const accountAssetClientV3 =  new RestClientV5({
            key: publicKey,
            secret: privateKey,
            testnet:testnet
        });
    ...
    static  createAccountAssetClient({privateKey,publicKey,testnet}){
        const accountAssetClient =  new AccountAssetClient({
            key: publicKey,
            secret: privateKey,
            testnet:testnet
        });
        return accountAssetClient;
    ...
    /**
     * 
     * @param {{accountAssetClientV3:AccountAssetClientV3,accountAssetClient:AccountAssetClient,millisecondsToDelayBetweenRequests:number}} settings 
     */
    constructor({accountAssetClientV3,accountAssetClient,millisecondsToDelayBetweenRequests}){
        this.#accountAssetClientV3 = accountAssetClientV3;
        this.#accountAssetClient = accountAssetClient;
